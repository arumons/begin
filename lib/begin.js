(function() {
  var ArrayUnits, Arrays, Def, Scope, Unit, Units, arrays, begin, def, macro, util;
  var __slice = Array.prototype.slice, __hasProp = Object.prototype.hasOwnProperty;
  util = require('util');
  Scope = (function() {
    function Scope(unit) {
      var jumped, _err_msg, _pre_iterator_function, _pre_scope_transition_function;
      jumped = false;
      ...
      this.every = function() {
        ...
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        _ref = _pre_iterator_function(args), _arrays = _ref._arrays, defed = _ref.defed, thisp = _ref.thisp, units = _ref.units;
        _arrays.forEach(function(item, index, array) {
          units._(function() {
            return this._(function() {
      ...
      this.reduceRight = function(block, init) {
